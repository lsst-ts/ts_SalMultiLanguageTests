...
#########################
SalMultiLanguageTests
#########################

.. update the following links to point to your CSC
.. image:: https://img.shields.io/badge/GitHub-gray.svg
    :target: https://github.com/lsst-ts/ts_SalMultiLanguageTests
.. image:: https://img.shields.io/badge/Jira-gray.svg
    :target: https://jira.lsstcorp.org/issues/?jql=labels+%3D+ts_SalMultiLanguageTests
.. image:: https://img.shields.io/badge/Jenkins-gray.svg
    :target: https://tssw-ci.lsst.org/job/LSST_Telescope-and-Site/job/ts_SalMultiLanguageTests/

.. TODO: Delete the note when the page becomes populated

.. Warning::

   **This documentation is under development and not ready for active use.**
...
As with all CSCs, information on the package, developers and product owners can be found in the `Master CSC Table <ts_xml:index:master-csc-table:SalMultiLanguageTests>`_.

.. note:: If you are interested in viewing other branches of this repository append a `/v` to the end of the url link. For example `https://ts_SalMultiLanguageTests.lsst.io/v/`
...
User-level documentation, found at the link below, is aimed at personnel looking to perform the standard use-cases/operations with the SalMultiLanguageTests.
...
Configuring the SalMultiLanguageTests
=========================================
...
The configuration for the SalMultiLanguageTests is described at the following link.
...
This area of documentation focuses on the classes used, API's, and how to participate to the development of the SalMultiLanguageTests software packages.
...
The version history of the SalMultiLanguageTests is found at the following link.
